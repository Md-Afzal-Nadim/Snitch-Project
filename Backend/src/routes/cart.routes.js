...
import { addToCart, getCart, incrementCartItemQuantity, decrementCartItemQuantity, createOrderController, verifyOrderController, getUserOrdersController, getOrderByIdController } from "../controllers/cart.controller.js";
...
// Get user's past orders/payments
router.get("/payment/orders", authenticateUser, getUserOrdersController);
...
router.get("/payment/order/:razorpayOrderId", authenticateUser, getOrderByIdController);
